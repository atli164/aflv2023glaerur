...
\begin{frame}[plain]{Types of edges}
    \begin{columns}[T]
        \begin{column}{.6\textwidth}
            \begin{itemize}
...
\begin{frame}[plain,fragile]{Adjacency list}
...
\begin{frame}[plain,fragile]{Adjacency list (directed)}
...
\begin{frame}[plain,fragile]{Vertex properties (undirected graph)}
    \begin{columns}[T]
        \begin{column}{.6\textwidth}
            \vspace{20pt}
            \begin{itemize}
...
\begin{frame}[plain]{Vertex properties (directed graph)}
    \begin{columns}[T]
        \begin{column}{.6\textwidth}
            \begin{itemize}
                \onslide<1->{
...
\begin{frame}[plain,fragile]{Depth-first search}
  \begin{figure}
...
\begin{frame}[plain,fragile]{Connected components}
...
\begin{frame}[plain,fragile]{Analyzing the DFS tree}
    \begin{minted}[fontsize=\scriptsize]{cpp}
const int n = 1000;
vector<int> adj[n];
...
\begin{frame}[plain,fragile]{Bridges}
...
% \begin{frame}[plain]{Example problem: Ordering Tasks}
%     \begin{itemize}
...
\begin{frame}[plain,fragile]{Breadth-first search}
...
\begin{frame}[plain,fragile]{Shortest path in unweighted graphs}
